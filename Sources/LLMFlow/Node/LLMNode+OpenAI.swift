...
public struct ModelReponseRequestInputItemMessage: Codable {
    ...
    public let content: ModelReponseRequestInputItemMessageContent
    ...
    init(content: ModelReponseRequestInputItemMessageContent, role: ModelReponseRequestInputItemMessageRole) {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        let role = try container.decode(ModelReponseRequestInputItemMessageRole.self, forKey: .role)
        let content = try container.decode(ModelReponseRequestInputItemMessageContent.self, forKey: .content)
...
public enum ModelReponseRequestInputItem: Codable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        if let modelReponseRequestInputItemMessage = try? container.decode(ModelReponseRequestInputItemMessage.self) {
            self = .message(modelReponseRequestInputItemMessage)
            return
        }
        
        if let modelReponseRequestInputItemContext = try? container.decode(ModelReponseRequestInputItemContext.self) {
            self = .item(modelReponseRequestInputItemContext)
            return
        }
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        case .item(let modelReponseRequestInputItemContext):
...
public struct ModelReponseRequestResoning: Codable {
    ...
    let generateSummary: ModelReponseRequestResoningGenerateSummary?
...
public struct ModelReponseRequestToolWebSearch: Codable {
    ...
    let searchContextSize: ModelReponseRequestToolWebSearchContextSize?

    /// Approximate location parameters for the search.
    let userLocation: ModelReponseRequestToolWebSearchUserLocation
